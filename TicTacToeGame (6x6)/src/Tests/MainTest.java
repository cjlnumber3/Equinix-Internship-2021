...
class MainTest {
    ...
    public void winConditionsHorizontalRow1() {
        ...
        Main.gameBoard[0][3] = winningPlayer;
        Main.gameBoard[0][4] = winningPlayer;
        Main.gameBoard[0][5] = winningPlayer;
        Main.winConditions();
    ...
    public void winConditionsHorizontalRow2() {
        ...
        Main.gameBoard[1][3] = winningPlayer;
        Main.gameBoard[1][4] = winningPlayer;
        Main.gameBoard[1][5] = winningPlayer;
        Main.winConditions();
    ...
    public void winConditionsHorizontalRow3() {
        ...
        Main.gameBoard[2][2] = winningPlayer;
        Main.gameBoard[2][3] = winningPlayer;
        Main.gameBoard[2][4] = winningPlayer;
        Main.gameBoard[2][5] = winningPlayer;
        Main.winConditions();
    ...
    public void winConditionsHorizontalRow4() {
        ...
        Main.gameBoard[3][0] = winningPlayer;
        Main.gameBoard[3][1] = winningPlayer;
        Main.gameBoard[3][2] = winningPlayer;
        Main.gameBoard[3][3] = winningPlayer;
        Main.gameBoard[3][4] = winningPlayer;
        Main.gameBoard[3][5] = winningPlayer;
        Main.winConditions();
    ...
    public void winConditionsHorizontalRow5() {
        ...
        Main.gameBoard[4][0] = winningPlayer;
        Main.gameBoard[4][1] = winningPlayer;
        Main.gameBoard[4][2] = winningPlayer;
        Main.gameBoard[4][3] = winningPlayer;
        Main.gameBoard[4][4] = winningPlayer;
        Main.gameBoard[4][5] = winningPlayer;
        Main.winConditions();
    ...
    public void winConditionsHorizontalRow6() {
        ...
        Main.gameBoard[5][0] = winningPlayer;
        Main.gameBoard[5][1] = winningPlayer;
        Main.gameBoard[5][2] = winningPlayer;
        Main.gameBoard[5][3] = winningPlayer;
        Main.gameBoard[5][4] = winningPlayer;
        Main.gameBoard[5][5] = winningPlayer;
        Main.winConditions();
